...
const Cart = () => {
  ...
  const decreaseQty = (id, quantity, stock) => {
    if(quantity > 1) {
      const newQty = quantity-1;
      dispatch(updateCartQuantity(id, newQty, stock));
    } else {
          ...
          <div className="row d-flex justify-content-between cartt">
                  ...
                  <div className="row">
                    ...
                    <div className="col-4 col-lg-3 mt-4 mt-lg-0">
                      <div className="stockCounter d-inline">
                        <span onClick={() => decreaseQty(item.foodItem, item.quantity, item.stock)} className="btn btn-danger minus">-</span>
                        <input
                          type="number"
                          ...
                          readOnly
                        />
                        <span onClick={() => increaseQty(item.foodItem, item.quantity, item.stock)} className="btn btn-primary plus">+</span>
                      </div>
                    </div>
            ...
            <div className="col-12 col-lg-3 my-4">
              <div id="order_summary">
                ...
                <hr />
                <button onClick={checkOutHanlder}  id="checkout_btn" className="btn btn-primary btn-block">
                  Check Out
                </button>
              </div>
            </div>
